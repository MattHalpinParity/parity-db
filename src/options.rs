...
pub struct ColumnOptions {
	...
	/// Column is a Multitree column. This allows committing and querying of tree structures.
	pub multitree: bool,
}
...
impl ColumnOptions {
	fn as_string(&self) -> String {
		format!(
			...
			self.preimage, self.uniform, self.ref_counted, self.compression as u8, self.btree_index, self.multitree,
		)
	}
